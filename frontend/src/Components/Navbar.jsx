...
const products = [
  { name: 'Analytics', description: 'Get a better understanding of your meals', href: '#', icon: ChartPieIcon },
    ...
    <header className="bg-white">
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          ...
          <a href="#WhyUs" className="text-sm/6 font-semibold text-gray-900">
            Features
          </a>
